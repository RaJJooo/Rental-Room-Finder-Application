...
const Newsletter = () => {
  return (
    <div className="flex flex-col justify-center items-center mx-auto shadow-[0px_4px_25px_0px_#0000000D] text-gray-900/60 rounded-xl max-w-lg md:w-full w-11/12 md:py-8 py-10">
      ...
      <div className="flex items-center mt-5 w-full md:px-16 px-6">
        ...
        <button
          type="button"
          className="font-medium text-sm text-white bg-gray-900/90 w-36 h-10 rounded-r-md cursor-pointer"
        >
          Subscribe
        </button>
      </div>
