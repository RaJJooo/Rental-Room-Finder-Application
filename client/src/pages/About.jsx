...
const AboutPage = () => {
  return (
    ...
    >
      <div class="flex flex-wrap  space-x-2 text-sm text-gray-500 font-medium py-8">
        <a href="/">Home</a>
        <svg
          width="20"
          height="20"
      ...
      <p className="text-gray-600 leading-relaxed max-w-4xl text-lg">
        ...
        We will soon expand to all the Major Cities of the Country.
      </p>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 mt-12">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-gray-600 leading-relaxed text-lg">
            ...
            stays. We ensure the places listed and the people looking for a stay
            are selected based on careful filtering criteria so that both
            parties benefit and the safety of all involved persons is ensured.
            We know how important a safe home is to you at both ends of the deal
            and that is a promise we make.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row-reverse items-center gap-10 mt-16">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-gray-600 leading-relaxed text-lg mb-4">
            ...
            is safe for them. These places can be searched based on locality,
            budget, need, and multiple other filters. Find the perfect PG stay
            or guest with us.
          </p>

          <p className="text-gray-600 leading-relaxed text-lg">
            To meet our aim, we eliminate the two major problems a guest or host
            may face. The first of these is the lack of information for anyone
            new in a city. Our site will list all the...
          </p>
        </div>
      </div>
